        ...
        <main className="">
          <div className="p-6 gap-6 mx-auto max-w-4xl py-12 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <h1 className="text-3xl font-semibold font-[family-name:var(--font-display)]">{String(row.ingredient ?? 'Recipe Ingredient')}</h1>
            ...
            <Card className="rounded-[0.5rem] border border-border shadow-sm transition-all duration-200 hover:scale-[1.02]"><CardHeader><CardTitle>Details</CardTitle></CardHeader><CardContent><dl>
              ...
              <div className="py-2 border-b last:border-0">
                <dt className="text-xs uppercase tracking-wide text-muted-foreground">Ingredient</dt>
                <dd className="text-sm mt-1">{String(row.ingredient ?? '—')}</dd>
              </div>
              <div className="py-2 border-b last:border-0">
